        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {loading ? '...' : formatNumber(stats.totalSent)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              {loading ? '...' : `${formatPercentage(stats.deliveryRate)}%`}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">
              {loading ? '...' : `${formatPercentage(stats.openRate)}%`}
            </div>
            <p className="text-xs text-gray-500 mt-1">
              {formatNumber(stats.opened)} opened
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">
              {loading ? '...' : `${formatPercentage(stats.clickRate)}%`}
            </div>
            <p className="text-xs text-gray-500 mt-1">
              {formatNumber(stats.clicked)} clicked
            </p>
          </CardContent>
        </Card>
      </div>
